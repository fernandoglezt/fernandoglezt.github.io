...
function actualiza(){
	planetaTierra.position.x = 200*Math.cos(pos);
	planetaTierra.position.y = 200*Math.sin(pos);
	planetaTierra.rotation.y += 0.01;
	
	luna.position.x = 200*Math.cos(pos)+120*Math.cos(posLuna);
	luna.position.y = 200*Math.sin(pos)+120*Math.sin(posLuna);	
